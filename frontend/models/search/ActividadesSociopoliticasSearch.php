...
/**
 * ActividadesSociopoliticasSearch represents the model behind the search form about `frontend\models\ActividadesSociopoliticas`.
 */
class ActividadesSociopoliticasSearch extends ActividadesSociopoliticas
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = ActividadesSociopoliticas::find();
