...
class UserSearch extends User
{
    ...
    {
        return [
            [['id', 'status', 'created_at', 'updated_at', 'rol_id','id_division'], 'integer'],
            [['username', 'auth_key', 'password_hash', 'password_reset_token', 'email', 'nombre', 'apellido', 'cedula','id_supervisor'], 'safe'],
        ];
    }
